...
def plot_training(history):
    ...
    plt.title('NWPU Train and Test accuracy')
    plt.legend()
    ...
    plt.title('NWPU Train and Test loss')
    plt.legend()
    plt.savefig("/Users/mac/Documents/GitHub/models/summary/self_design_NWPU45.png")
    plt.show()

plot_training(history_ft)
model.save('/Users/mac/Documents/GitHub/models/summary/self_design_NWPU45.h5')