...
history = model.fit(dataset,epochs=15,steps_per_epoch=60,validation_data=dataset_test,validation_steps=15)
...
plt.savefig("/Users/mac/Documents/GitHub/models/2_25/acc_3.png")
plt.show()
...
plt.ylabel("loss")
plt.title("February_45_class45")
plt.savefig("/Users/mac/Documents/GitHub/models/2_25/loss_3.png")
plt.show()